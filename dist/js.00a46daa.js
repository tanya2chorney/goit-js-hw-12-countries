...
function fetchCountries(searchQuery) {
  ...
  return fetch("".concat(BASE_URL, "/").concat(searchQuery, "?fields=name,capital,population,languages,flag")).then(function (response) {
    if (!response.ok) {
...
function renderCountryInfo(country) {
  var name = country.name,
    ...
    flag = country.flag;
  countryInfo.innerHTML = "\n        <h2>".concat(name, "</h2>\n        <img src=\"").concat(flag, "\" alt=\"\u041F\u0440\u0430\u043F\u043E\u0440 ").concat(name, "\" width=\"300\">\n        <p><strong>\u0421\u0442\u043E\u043B\u0438\u0446\u044F:</strong> ").concat(capital, "</p>\n        <p><strong>\u041D\u0430\u0441\u0435\u043B\u0435\u043D\u043D\u044F:</strong> ").concat(population.toLocaleString(), "</p>\n        <p><strong>\u041C\u043E\u0432\u0438:</strong> ").concat(languages.map(function (lang) {
    return lang.name;
  }).join(", "), "</p>\n    ");
}
